...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_account_to_user" .
 */
class AccountToUserQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_account_to_user.id id", "CONCAT_WS(' ', id) text"]);
    }
