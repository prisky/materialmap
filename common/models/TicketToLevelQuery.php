...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_ticket_to_level" .
 */
class TicketToLevelQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_ticket_to_level.id id", "CONCAT_WS(' ', id) text"]);
    }
