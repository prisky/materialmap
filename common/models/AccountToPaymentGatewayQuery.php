...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_account_to_payment_gateway" .
 */
class AccountToPaymentGatewayQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_account_to_payment_gateway.id id", "CONCAT_WS(' ', id) text"]);
    }
