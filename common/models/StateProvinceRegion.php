...
/**
 * This is the model class for table "tbl_state_province_region".
 *
 * @property integer $id
...
class StateProvinceRegion extends \common\components\ActiveRecord
{
    ...
    {
        return 'tbl_state_province_region';
    }
    ...
    {
        return $this->hasMany(TownCity::className(), ['state_province_region' => 'id']);
    }
}
