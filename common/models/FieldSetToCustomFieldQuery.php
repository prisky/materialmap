...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_field_set_to_custom_field" .
 */
class FieldSetToCustomFieldQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_field_set_to_custom_field.id id", "CONCAT_WS(' ', id) text"]);
    }
