...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_referral" .
 */
class ReferralQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_referral.id id", "CONCAT_WS(' ', id) text"]);
    }
