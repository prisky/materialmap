...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_reader_model" .
 */
class ReaderModelQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_reader_model.id id", "CONCAT_WS(' ', `name`) text"]);
    }
