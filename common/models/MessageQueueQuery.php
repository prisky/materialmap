...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_message_queue" .
 */
class MessageQueueQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_message_queue.id id", "CONCAT_WS(' ', email_subject, sms_message) text"]);
    }
