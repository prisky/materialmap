...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_event_type_to_field_set" .
 */
class EventTypeToFieldSetQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_event_type_to_field_set.id id", "CONCAT_WS(' ', id) text"]);
    }
