...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_resource_type_to_message" .
 */
class ResourceTypeToMessageQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_resource_type_to_message.id id", "CONCAT_WS(' ', email_subject, sms_message) text"]);
    }
