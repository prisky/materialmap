...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_ticket_type" .
 */
class TicketTypeQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_ticket_type.id id", "CONCAT_WS(' ', name) text"]);
    }
