...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_survey_result_to_summary" .
 */
class SurveyResultToSummaryQuery extends \common\components\ActiveQuery
{
