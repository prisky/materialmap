...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_resource_type" .
 */
class ResourceTypeQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_resource_type.id id", "CONCAT_WS(' ', name) text"]);
    }
