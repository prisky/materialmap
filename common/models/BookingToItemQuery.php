...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_booking_to_item" .
 */
class BookingToItemQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_booking_to_item.id id", "CONCAT_WS(' ', id) text"]);
    }
