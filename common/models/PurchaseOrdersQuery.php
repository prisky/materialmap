...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_purchase_orders" .
 */
class PurchaseOrdersQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_purchase_orders.id id", "CONCAT_WS(' ', name, construction_work_pack) text"]);
    }
