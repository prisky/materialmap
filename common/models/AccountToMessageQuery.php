...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_account_to_message" .
 */
class AccountToMessageQuery extends \common\components\ActiveQuery
{
