...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_auth_rule" .
 */
class AuthRuleQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_auth_rule.id id", "CONCAT_WS(' ', name) text"]);
    }
