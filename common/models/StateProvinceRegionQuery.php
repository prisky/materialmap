...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_state_province_region" .
 */
class StateProvinceRegionQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_state_province_region.id id", "CONCAT_WS(' ', name) text"]);
    }
