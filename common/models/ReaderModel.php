...
/**
 * This is the model class for table "tbl_reader_model".
 *
 * @property integer $id
 ...
 */
class ReaderModel extends \common\components\ActiveRecord
{
    ...
    {
        return $this->hasMany(Reader::className(), ['rfid_model_id' => 'id']);
    }
