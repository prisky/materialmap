...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_bid" .
 */
class BidQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_bid.id id", "CONCAT_WS(' ', id) text"]);
    }
