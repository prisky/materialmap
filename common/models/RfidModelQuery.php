...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_rfid_model" .
 */
class RfidModelQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_rfid_model.id id", "CONCAT_WS(' ', name) text"]);
    }
