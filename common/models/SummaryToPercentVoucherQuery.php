...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_summary_to_percent_voucher" .
 */
class SummaryToPercentVoucherQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_summary_to_percent_voucher.id id", "CONCAT_WS(' ', id) text"]);
    }
