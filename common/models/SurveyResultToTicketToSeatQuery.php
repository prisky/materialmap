...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_survey_result_to_ticket_to_seat" .
 */
class SurveyResultToTicketToSeatQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_survey_result_to_ticket_to_seat.id id", "CONCAT_WS(' ', custom_value) text"]);
    }
