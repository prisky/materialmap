...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_event_type_to_resource_type_to_custom_field" .
 */
class EventTypeToResourceTypeToCustomFieldQuery extends \common\components\ActiveQuery
{
