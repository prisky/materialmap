...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_standard_setup" .
 */
class StandardSetupQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_standard_setup.id id", "CONCAT_WS(' ', id) text"]);
    }
