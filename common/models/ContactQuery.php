...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_contact" .
 */
class ContactQuery extends \common\components\ActiveQuery
{
...
//				$this->andWhere("CONCAT_WS(' ', email, first_name, last_name) LIKE :like", [':like' => "%$like%"]);
				$this->andWhere("CONCAT_WS(' ', first_name, last_name, email, phone_mobile) LIKE :like", [':like' => "%$like%"]);
			}
		}
