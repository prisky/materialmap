...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_booking_to_custom_field" .
 */
class BookingToCustomFieldQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_booking_to_custom_field.id id", "CONCAT_WS(' ', custom_value) text"]);
    }
