...
/**
 * Scopes chained to the find method of an ActiveRecord  for table "tbl_site_location" .
 */
class SiteLocationQuery extends \common\components\ActiveQuery
{
    ...
    public function display($q = null, $page = null)
    {
        ...
        return parent::display($q, $page)
            ...
            ->select(["tbl_site_location.id id", "CONCAT_WS(' ', name, latitude, longitude) text"]);
    }
