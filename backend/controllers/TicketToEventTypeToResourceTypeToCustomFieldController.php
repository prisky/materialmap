...
/**
 * TicketToEventTypeToResourceTypeToCustomFieldController implements the CRUD actions for TicketToEventTypeToResourceTypeToCustomField model.
 */
class TicketToEventTypeToResourceTypeToCustomFieldController extends \backend\components\Controller
{
	/**
	 * @inheritdoc
	 */
