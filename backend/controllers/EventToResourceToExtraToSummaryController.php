...
class EventToResourceToExtraToSummaryController extends \backend\components\Controller
{
	...
	/**
	 * Produce widget options for a Select2 widget for the event_to_resource_to_extra_id foreign key attribute
	...
	/**
	 * Produce widget options for a Select2 widget for the summary_id foreign key attribute
