...
class TownCityController extends \backend\components\Controller
{
	...
	/**
	 * Produce widget options for a Select2 widget for the state_province_id foreign key attribute
	 * referencing the tbl_state_province table
	 ...
	 */
	 public function actionStateprovincelist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('StateProvince', $q, $page, $id);
	}
