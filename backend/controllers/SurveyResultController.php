...
class SurveyResultController extends \backend\components\Controller
{
	 ...
	 * referencing the tbl_survey_to_custom_field table
	 ...
	 */
	 public function actionSurveytocustomfieldlist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('SurveyToCustomField', $q, $page, $id);
	}
