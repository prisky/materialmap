...
/**
 * EventDetailToTicketTypeController implements the CRUD actions for EventDetailToTicketType model.
 */
class EventDetailToTicketTypeController extends \backend\components\Controller
{
