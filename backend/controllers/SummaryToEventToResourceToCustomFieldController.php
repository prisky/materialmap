...
/**
 * SummaryToEventToResourceToCustomFieldController implements the CRUD actions for SummaryToEventToResourceToCustomField model.
 */
class SummaryToEventToResourceToCustomFieldController extends \backend\components\Controller
{
