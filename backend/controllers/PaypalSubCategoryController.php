...
class PaypalSubCategoryController extends \backend\components\Controller
{
	...
	/**
	 * Produce widget options for a Select2 widget for the paypal_category_id foreign key attribute
	 * referencing the tbl_paypal_category table
	 ...
	 */
	 public function actionPaypalcategorylist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('PaypalCategory', $q, $page, $id);
	}
