...
class PercentVoucherConstraintController extends \backend\components\Controller
{
	 ...
	 * referencing the tbl_percent_voucher table
	 ...
	 */
	 public function actionPercentvoucherlist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('PercentVoucher', $q, $page, $id);
	}
