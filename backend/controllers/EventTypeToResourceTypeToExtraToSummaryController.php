...
/**
 * EventTypeToResourceTypeToExtraToSummaryController implements the CRUD actions for EventTypeToResourceTypeToExtraToSummary model.
 */
class EventTypeToResourceTypeToExtraToSummaryController extends \backend\components\Controller
{
	/**
	 * @inheritdoc
	 */
