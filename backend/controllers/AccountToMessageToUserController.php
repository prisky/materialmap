...
class AccountToMessageToUserController extends \backend\components\Controller
{
	 ...
	 * referencing the tbl_account_to_message table
	 ...
	 */
	 public function actionAccounttomessagelist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('AccountToMessage', $q, $page, $id);
	}
