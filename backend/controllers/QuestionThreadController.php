...
/**
 * QuestionThreadController implements the CRUD actions for QuestionThread model.
 */
class QuestionThreadController extends \backend\components\Controller
{
	
	/**
	 * Produce widget options for a Select2 widget for the account_id foreign key attribute
	 * referencing the tbl_question table
	 ...
	 */
	 public function actionQuestionlist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('Question', $q, $page, $id);
	}
