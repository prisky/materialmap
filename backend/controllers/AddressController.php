...
class AddressController extends \backend\components\Controller
{
	...
	/**
	 * Produce widget options for a Select2 widget for the town_city_id foreign key attribute
	 * referencing the tbl_town_city table
	 ...
	 */
	 public function actionTowncitylist($q = null, $page = null, $id = null) {
		$this->foreignKeylist('TownCity', $q, $page, $id);
	}
