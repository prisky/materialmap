...
/**
 * This will only be needed for the $attribute property once the kartig-v adds enhancements for range filtering included here
 * and combines with some styles in site.css
 */
class FieldRange extends \yii\base\Widget
{
    ...
    protected function registerAssets()
    {
        ...
        $this->options['data-plugin-options'] = $hashVar;
